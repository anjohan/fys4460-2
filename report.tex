...
The velocity of the centre of mass of a group can be calculated by LAMMPs. This is equal to the mean velocity of the atoms in the group. \Vref{fig:cylindervxcm} show the time evolution., while \Vref{fig:cylindervx} shows the radial distribution after the system has reached equilibrium.
...
\]
\Vref{fig:cylindervx} shows the quality of the approximation.
\begin{figure}[tbh]
    \centering
    \begin{tikzpicture}
        \begin{axis}[
